...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001744938590', '-1001541932075').split()]
...
S_GROUP = environ.get('S_GROUP',"https://t.me/CV_official")
MAIN_CHANNEL = environ.get('MAIN_CHANNEL',"https://t.me/CV_Linkz")
FILE_FORWARD = environ.get('FILE_FORWARD',"https://t.me/+kdOA7HMC2L42YzM1")
...
#Fsub
auth_channel = environ.get('-1001744938590')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
# Set to False inside the bracket if you don't want to use Request Channel else set it to Channel ID
REQ_CHANNEL = environ.get("-1001744938590", True)
REQ_CHANNEL = int(REQ_CHANNEL) if REQ_CHANNEL and id_pattern.search(REQ_CHANNEL) else False
JOIN_REQS_DB = environ.get("JOIN_REQS_DB", mongodb+srv://hyonjoo:hyonjoo@cluster0.lv6txrr.mongodb.net/?retryWrites=true&w=majority)
